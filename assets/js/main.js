/*=============== FILTERS TABS ===============*/
const tabs = document.querySelectorAll('[data-target]'),//accede al documento y buscan data target
...
const COMMANDS = {
  ...
  about:
    "mi name is Angelica visit my <a href ='https://github.com/angelica.leon.quiroga' target='_blank' style='color:#000;'> Github",
  ls:
    "usr&nbsp;&nbsp;&nbsp;&nbsp;home&nbsp;&nbsp;&nbsp;&nbsp;var&nbsp;&nbsp;&nbsp;&nbsp;root",
  ...
  contact:
    "Email (angelica.leon.quiroga@gmail.com): <a class='link' href='https://mail.google.com/'>Gmail</a><br>Form: <a href='/contact' class='link'> Anon Message</a><br>",
};
